 ...
 * @function
 */
public class CustomComboIocLoader implements IocLoader {
     ...
     */
    public CustomComboIocLoader(String... args) throws ClassNotFoundException {
        if (loaders.isEmpty()) {
            loaders.put("js", JsonLoader.class);
            loaders.put("json", JsonLoader.class);
            loaders.put("xml", XmlIocLoader.class);
            loaders.put("annotation", CustomNutzAnnotationIocLoader.class);
            loaders.put("anno", CustomNutzAnnotationIocLoader.class);
    ...
    public CustomComboIocLoader(IocLoader... loaders) {
        ...
        for (IocLoader iocLoader : iocLoaders)
            if (iocLoader.has(name)) {
                ...
                if (log.isDebugEnabled()) {
                    ...
                    String printName;
                    if (iocLoader instanceof CustomNutzAnnotationIocLoader) {
                        String packages = Arrays.toString(((CustomNutzAnnotationIocLoader) iocLoader).getPackages());
                        printName = "CustomNutzAnnotationIocLoader(packages=" + packages + ")";
    ...
    public String toString() {
        ...
        sb.append("/*CustomComboIocLoader*/\n{");
        for (IocLoader loader : iocLoaders) {
